...
using gem5::PciDevice;
using gem5::PciDeviceParams;
using gem5::EventFunctionWrapper;
using gem5::Addr;
using gem5::Tick;
using gem5::statistics::Scalar;
using gem5::NVMeInterfaceParams;
using gem5::CheckpointIn;
using gem5::CheckpointOut;
