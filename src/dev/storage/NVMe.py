...
class NVMeInterface(PciDevice):
    ...
    BAR0 = PciMemBar(size="8192B")
    BAR4 = PciMemBar(size="8192B")
    BAR5 = PciMemBar(size="4096B")
    ...
    PXCAPDevCapabilities = 0x10008000  # 74    Function Level Reset Capability | Role-based Error Reporting
    ...
    PMCAPCapabilities = (
        0x0003  # A6    Device Specific Initialization (No) | Version (1.2)
    )
